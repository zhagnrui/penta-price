...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const tool = dict.calcIndex.tools.lubricant
  return {
    title: `${tool.title} | PentaPrice`,
    description: tool.desc,
    alternates: {
      canonical: `${SITE_URL}/${lang}/calculator/lubricant`,
      languages: {
        zh: `${SITE_URL}/zh/calculator/lubricant`,
        en: `${SITE_URL}/en/calculator/lubricant`,
        de: `${SITE_URL}/de/calculator/lubricant`,
      },
    },
  }
}

export default async function LubricantPage({ params }: Props) {
  const { lang } = await params
  ...
  return (
    <main className="pe-main">
      ...
      <LubricantCalc lang={lang} dict={dict} />
    </main>
  )
}
